...
def lambda_handler(event, context):
    api_url = "https://www.football-data.co.uk/mmz4281/2324/all-euro-data-2023-2024.xlsx"
    bucket_name = "footballprediction-matchfixturesbucket"
    ...
    file_path = f"raw-data/year={year}/month={month}/day={day}/EUMatchFixture.csv"
    print(file_path)
